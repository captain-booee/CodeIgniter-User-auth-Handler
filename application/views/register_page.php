...
<input type="password" name="password" value=""  class="form-control" id="exampleInputPass1" aria-describedby="passHelp"/>
<small id="passHelp" class="form-text text-muted"><?php echo form_error('password', '<div class="error">', '</div>'); ?></small>
</div>

<div class="form-group">
<label for="exampleInputPassconf1">Password Confirm</label>
<input type="password" name="passconf" value=""  class="form-control" id="exampleInputPassconf1" aria-describedby="passconfHelp"/>
<small id="passconfHelp" class="form-text text-muted"><?php echo form_error('passconf', '<div class="error">', '</div>'); ?></small>
</div>
